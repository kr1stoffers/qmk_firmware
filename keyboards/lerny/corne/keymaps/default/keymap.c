...
#define HOME_COMM RALT_T(KC_COMM)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
//      |----------+----------+----------+----------+----------+----------|                            |----------+----------+----------+----------+----------+----------|
           RIGHT_WS,      KC_W,      KC_L,      KC_Y,      KC_P,      KC_B,                                   KC_Z,      KC_F,      KC_O,      KC_U,   KC_QUOT,   KC_LBRC, 
//      |----------+----------+----------+----------+----------+----------|                            |----------+----------+----------+----------+----------+----------|
            LEFT_WS,    HOME_C,    HOME_R,    HOME_S,    HOME_T,      KC_G,                                   KC_M,    HOME_N,    HOME_E,    HOME_I,    HOME_A,   KC_SCLN, 
//      |----------+----------+----------+----------+----------+----------|                            |----------+----------+----------+----------+----------+----------|
            XXXXXXX,      KC_Q,    HOME_J,      KC_V,      KC_D,      KC_K,                                   KC_X,      KC_H,   KC_SLSH, HOME_COMM,    KC_DOT,   KC_RBRC, 
//      |----------+----------+----------+----------+----------+----------+----------|      |----------+----------+----------+----------+----------+----------+----------|
...
//                                                  |----------+----------+----------|      |----------+----------+----------|
    ...
    [_GAME] = LAYOUT(
//      |----------+----------+----------+----------+----------+----------|                            |----------+----------+----------+----------+----------+----------|
               KC_I,    KC_TAB,      KC_Q,      KC_W,      KC_E,      KC_R,                                XXXXXXX,   TD_BASE,   XXXXXXX,   XXXXXXX,   TD_BOOT,   XXXXXXX, 
//      |----------+----------+----------+----------+----------+----------|                            |----------+----------+----------+----------+----------+----------|
...
//      |----------+----------+----------+----------+----------+----------+----------|      |----------+----------+----------+----------+----------+----------+----------|
                                                       GAME_FUN,    KC_SPC,  GAME_NUM,          XXXXXXX,   XXXXXXX,   XXXXXXX
//                                                  |----------+----------+----------|      |----------+----------+----------|
    ),
